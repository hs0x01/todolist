...
public class TodoListService {
    ...
    public void validateSave(Todo todo) {
        ...
        if (todo.getPriority() == null || Util.getEnum(Priority.class, todo.getPriority()) == null) {
            throw new IllegalArgumentException("Todo#priority is invalid.");
        }
        if (todo.getStatus() == null || Util.getEnum(Status.class, todo.getStatus()) == null) {
    ...
    public void save(List<Todo> todoList) {
        ...
        for (Todo todo : todoList) {
            ...
            while (todoListInDbItr.hasNext()) {
                ...
                if (todo.getId() != null && todo.getId().equals(todoInDb.getId())) {
