...
public class TodoListServiceTest {
    ...
    public void save_引数のTODOリストでテーブルがリライトされること() {
        ...
        Todo todo1 = new Todo(null, Priority.HIGH.getValue(), Status.TODO.getValue(), "added");
        Todo todo2 = new Todo(2, Priority.HIGH.getValue(), Status.TODO.getValue(), "updated");
        Todo todo3 = new Todo(3, Priority.HIGH.getValue(), Status.TODO.getValue(), "deleted");
    ...
    public void save_引数のnullの場合テーブルがリライトされること() {
        ...
        Todo todo1 = new Todo(1, Priority.HIGH.getValue(), Status.TODO.getValue(), "deleted1");
        Todo todo2 = new Todo(2, Priority.HIGH.getValue(), Status.TODO.getValue(), "deleted2");
